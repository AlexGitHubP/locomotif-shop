...
<div class='filter-tab'>
	...
	<div class='actions-tab'>
		<ul class='action-controls'>
			<li>
				<a href="/admin/orders/create" class='iconControl'>
					<span>
			...
			<div class='listing-element {{ $loop->last ? 'lastElement' : '' }}'>
				...
				<div class='listing-box flex02 alignCenter'>
					<div class='more-actions-tab'>
						...
						<ul class='more-list'>
							<li>
								<form action="/admin/orders/{{ $item->id }}" method="POST">@method('DELETE') @csrf <input type="submit" value="Șterge"/></form>
							</li>
						</ul>
					</div>
				</div>
